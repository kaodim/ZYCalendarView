...
- (void)setMaxDate:(NSDate *)maxDate {
    _maxDate = maxDate;
    _manager.date = maxDate;
}

- (void)setSelectedDate:(NSDate *)selectedDate {
    _selectedDate = selectedDate;

    monthView1.date =  [self.manager.helper addToDate:selectedDate months:-2];
    monthView2.date = [self.manager.helper addToDate:selectedDate months:-1];
    monthView3.date = selectedDate;
    monthView4.date = [self.manager.helper addToDate:selectedDate months:1];
    monthView5.date = [self.manager.helper addToDate:selectedDate months:2];
}
@end
